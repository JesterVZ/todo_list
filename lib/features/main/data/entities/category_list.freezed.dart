...
mixin _$CategoryList {
  List<CategoryEntity> get values => throw _privateConstructorUsedError;
...
abstract class $CategoryListCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<CategoryEntity> values});
}
...
class _$_CategoryList extends _CategoryList {
  const _$_CategoryList({required final List<CategoryEntity> values})
      : _values = values,
        super._();

  final List<CategoryEntity> _values;
  @override
  List<CategoryEntity> get values {
...
abstract class _CategoryList extends CategoryList {
  const factory _CategoryList({required final List<CategoryEntity> values}) =
      _$_CategoryList;
